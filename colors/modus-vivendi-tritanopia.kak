...
set-face global keyword 'rgb:ff7f86'
...
set-face global ts_keyword_conditional          "%opt{red_bright}"
set-face global ts_keyword_control_conditional  "%opt{red_bright}"
set-face global ts_keyword_control_import       "%opt{red_bright}"
...
set-face global ts_type_parameter               "%opt{cyan_cooler}"
...
set-face global ts_namespace                    "%opt{blue_warmer}"
set-face global ts_label                        "%opt{cyan_cooler}"
